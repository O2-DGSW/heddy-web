(function () {
  /*VERSION:260324*/ function checkWebviewCustomUA(a) {
    for (
      var b = ["daum", "kakao", "naver", "google", "facebook", "twitter"],
        c = !1,
        d = 0,
        e = b.length;
      d < e;
  ...
  ((window.kakao = window.kakao || {}),
    window.daum ? (window.kakao = window.daum) : (window.daum = window.kakao),
    (function (a) {
      function b(a) {
        var b = {};
        return (
      ...
      for (var d = document.getElementsByTagName("script"), e = 0, f = d.length; e < f; ++e) {
        var g = d[e],
          h = g.src;
        if (
          /\/mapjsapi\/bundle\/postcode\/(prod){0,1}(dev){0,1}(cbt){0,1}\/postcode.v2\.js\b/.test(h)
        ) {
          c(b(h)) || (a.postcode._validParam_ = !1);
          break;
        }
      }
      ((a.postcode.version = "260324"),
      ...
      function str(a, b) {
        ...
        switch (
          ...
          case "object":
            if (!i) return "null";
            if (
              ((gap += indent), (g = []), "[object Array]" === Object.prototype.toString.apply(i))
            ) {
            ...
            if (rep && "object" == typeof rep)
              for (f = rep.length, c = 0; c < f; c += 1)
                "string" == typeof rep[c] &&
                  ((d = rep[c]), (e = str(d, i)), e && g.push(quote(d) + (gap ? ": " : ":") + e));
            else
              for (d in i)
  ...
  var postcodeConf = {
      ...
      devURL: "https://postcode.devel.kakao.com",
      cbtURL: "https://cbt-postcode.devel.kakao.com",
      prodURL: "https://postcode.map.kakao.com",
      noticeURL: "",
      noticeHeight: "80",
      noticeText:
  ...
  ((postcodeUtils.param = (function (a) {
    ...
    (postcodeUtils.isAvailable = function (a) {
      return (
        !postcodeUtils.isUndefined(a) && !postcodeUtils.isNull(a) && "" !== postcodeUtils.trim(a)
      );
    }),
    (postcodeUtils.event = {
      ...
      onTouch: function (a, b) {
        ...
        a &&
          (this.on(a, "touchstart", function (a) {
            h.stopPropagation(a);
            var b =
              (a.changedTouches && a.changedTouches[0]) || (a.touches && a.touches[0]) || null;
      ...
      (a.viewUtils = (function () {
        ...
        function l(a, b) {
          var c = "",
            d = 1e3,
            e = a + b;
          return (c = e.length > d ? a : e);
        }
        function m(a, b) {
          n(a, b) ||
            (q.POPUP_MAP[a] || (q.POPUP_MAP[a] = []),
            q.POPUP_MAP[a].push({ ref: b, data: { closeCallbackTimer: -1 } }));
        }
        function n(a, b) {
          if (q.POPUP_MAP[a])
        ...
        function p(a) {
          var b =
            ...
            ("msie" === f.userAgent.browser.name &&
              10 === parseInt(f.userAgent.browser.version.major, 10));
          if (b)
            try {
      ...
      (a.dataUtils = (function () {
        function a(a) {
          ...
          if (a && "J" === a.addressType) {
            for (
              var c = a.roadAddressEnglish || a.autoRoadAddressEnglish || "",
                d = c.replace(/^[^\s]+\s*/, ""),
                e = d.split(","),
                f = 0;
              f < e.length;
        ...
        return { adjustRoadnameEnglish: a };
      })()));
  ...
  !(function (a, b, c, d, e) {
    ...
    a.frame = (function () {
                ...
                "search" === f
                  ...
                  : "resize" === f
                    ? c.onResize !== g.EMPTY_FUNCTION &&
                      (c.onResize(i),
                      h.adjustLowIE(e, a, b, j.getId("viewerFrame", c.viewerNo), i.width, i.height))
                    : "done" === f &&
      ...
      function m(a) {
        ...
        if (
          (a.popupKey && o(e), f.userAgent.os.android && f.isAndroidWebview(f.userAgent.ua_string))
        ) {
      ...
      function n(a, b) {
        ...
        try {
          ...
          if (d) {
            var e = b.popupTitle || "Kakao Postcode Service",
              f = null,
              i = null,
          ...
          c &&
            ...
            (c.data.closeCallbackTimer = setInterval(function () {
              ...
              (d || void 0 !== a.closed || (d = void 0 === a.window || null === a.window),
                d &&
                  (clearInterval(c.data.closeCallbackTimer), b.onClose(g.POPUP_CLOSE_STATE.FORCE)));
            }, 250)));
        }
      }
      var q = null,
        ...
        t = function (a) {
          var b = {
            ...
            c = {
              ...
              inch: a.noticeHeight ? encodeURIComponent(a.noticeHeight) : "",
              inct: a.noticeText ? encodeURIComponent(a.noticeText) : "",
              incf: a.noticeFontSize ? encodeURIComponent(a.noticeFontSize) : "",
              ...
              a51:
                f.userAgent.os.android &&
                f.isAndroidWebview(f.userAgent.ua_string) &&
                f.userAgent.ua_string.indexOf("android 5.1") > -1
                  ? "on"
                  : "off",
            };
          ...
          var d = q + "&" + f.getStringByOptions(c, "=", "&"),
            e = "&" + f.getStringByOptions({ fullpath: r }, "=", "&"),
            g =
              ("&" + f.getStringByOptions({ fullpath: r + s }, "=", "&"),
              '<iframe frameborder="0" title="우편번호 검색 프레임" id="' +
                j.setId("viewerFrame", a.viewerNo) +
                '" src="' +
                h.getValidationUrl(d, e) +
                '" style="' +
        ...
        layer: {
          create: function (a, b) {
            ...
            b && "string" == typeof b
              ...
              : b && "object" == typeof b && b.appendChild && (c = b);
            var f = a.viewerNo - 1;
            if (f >= 1) {
  ...
  !(function (a, b, c, d, e) {
    var f = b,
      g =
        "msie" === f.userAgent.browser.name && parseInt(f.userAgent.browser.version.major, 10) <= 6;
    a.themePreprocessor = (function () {
      ...
      function b(a) {
        for (var b = v, d = !1, e = 0, g = b.length; e < g; e++)
          for (
            var h = b[e], i = h.keys, j = h.match, k = h.modifier, l = 0, m = j.length;
            l < m;
            l++
          ) {
            var n = j[l],
  ...
  !(function (a, b, c, d, e, f) {
    function g(a, b) {
      for (var c = 0; c < b; ++c)
        (alert(a), console && "function" == typeof console.error && console.error(a));
    }
    function h(a, b) {
      var c = a;
      if (b) {
        ...
        d &&
          ...
          (c =
            e === !0
              ...
              : p.extend(a, { userQuery: encodeURIComponent(d), cq: encodeURIComponent(d) }));
      }
      return c;
    }
    function i(a, b) {
    ...
    function j(a, b) {
      ...
      if (b) {
        ...
        d && "string" == typeof d && "" !== p.trim(d) && (c = p.extend(a, { popupKey: d }));
      }
      return c;
    }
    function k(a, b) {
      ...
      if (b) {
        var d = b.autoClose;
        void 0 !== d && null !== d && "boolean" == typeof d && (c = p.extend(a, { autoClose: d }));
      }
      return c;
    }
    function l(a, b) {
      ...
      if (b) {
        var d = b.popupTitle;
        d && "string" == typeof d && "" !== p.trim(d) && (c = p.extend(a, { popupTitle: d }));
      }
      return c;
    }
    function m(a) {
      ...
      (p.extend(c, a, {
        ...
        noticeHeight: q.noticeHeight,
        noticeFontSize: q.noticeFontSize,
      }),
        "string" == typeof c.minWidth
          ? isNaN(c.minWidth)
            ? (c.minWidth = r.MIN_WIDTH)
            : (c.minWidth = p.clamp(parseInt(c.minWidth, 10), 0, r.MIN_WIDTH))
          : "number" == typeof c.minWidth
            ? (c.minWidth = p.clamp(c.minWidth, 0, r.MIN_WIDTH))
            : (c.minWidth = r.MIN_WIDTH));
      ...
      if (
        ...
        c.onComplete && "function" == typeof c.onComplete && c.onComplete !== r.EMPTY_FUNCTION
          ? (c.onComplete = c.onComplete)
          : c.oncomplete && "function" == typeof c.oncomplete && c.oncomplete !== r.EMPTY_FUNCTION
            ? (c.onComplete = c.oncomplete)
            : ((c.onComplete = r.EMPTY_FUNCTION),
              (c.oncomplete = r.EMPTY_FUNCTION),
              (c.isViewerMode = !0)),
        c.onResize && "function" == typeof c.onResize && c.onResize !== r.EMPTY_FUNCTION
          ? (c.onResize = c.onResize)
          : c.onresize && "function" == typeof c.onresize && c.onresize !== r.EMPTY_FUNCTION
            ? (c.onResize = c.onresize)
            : ((c.onResize = r.EMPTY_FUNCTION), (c.onresize = r.EMPTY_FUNCTION)),
        c.onClose && "function" == typeof c.onClose && c.onClose !== r.EMPTY_FUNCTION
          ? (c.onClose = c.onClose)
          : c.onclose && "function" == typeof c.onclose && c.onclose !== r.EMPTY_FUNCTION
            ? (c.onClose = c.onclose)
            : ((c.onClose = r.EMPTY_FUNCTION), (c.onclose = r.EMPTY_FUNCTION)),
        c.onSearch && "function" == typeof c.onSearch && c.onSearch !== r.EMPTY_FUNCTION
          ? (c.onSearch = c.onSearch)
          : c.onsearch && "function" == typeof c.onsearch && c.onsearch !== r.EMPTY_FUNCTION
            ? (c.onSearch = c.onsearch)
            : ((c.onSearch = r.EMPTY_FUNCTION), (c.onsearch = r.EMPTY_FUNCTION)),
        ...
        "boolean" == typeof a.autoMapping &&
          (c.autoMappingJibun = c.autoMappingRoad = c.autoMapping),
        ...
        "boolean" != typeof c.alwaysShowEngAddr
          ? (c.alwaysShowEngAddr = !1)
          : c.alwaysShowEngAddr && (c.hideEngBtn = !0),
    ...
    var n = d.kakao.postcode;
    if (!n)
      return void alert(
        "[우편번호 서비스] API 로딩 오류가 발생하였습니다. 확인 바랍니다. 지속적인 오류 발생시 ( https://github.com/daumPostcode/QnA/issues ) 이슈 등록 부탁드립니다."
      );
    var o = (function (a) {
    ...
    o(
      !0,
      "[우편번호 서비스 로딩 오류] API 로딩시 허용되지 않는 파라미터가 감지되었습니다. 사이트 관리자(개발자)분께서는 가이드페이지( https://postcode.map.kakao.com/guide )의 기본 사용법을 참고하시어 수정 부탁드립니다."
    );
    var p = b,
      q = c,
      r = a.CONT,
      ...
      x = (w ? "https:" : "http:") + "//postcode.map.kakao.com/search",
      ...
      (m.prototype = {
        open: function (a) {
          if (
            !o(
              !1,
              "[우편번호 서비스] API 로딩시 허용되지 않은 파라미터가 감지되어 API 작동이 중지되었습니다. 사이트 관리자분께서는 가이드페이지( https://postcode.map.kakao.com/guide )의 기본 사용법을 참고하시어 수정 부탁드립니다."
            )
          ) {
