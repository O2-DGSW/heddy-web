...
const ScheduleEventCard = ({
  ...
  return (
    <article
      className="absolute overflow-hidden rounded-[0.4375rem]"
      style={{
        left: `${leftRem}rem`,
        top: `${topRem}rem`,
        width: `${SCHEDULE_EVENT_WIDTH_REM}rem`,
    ...
    >
      ...
      <div className="flex h-full items-center justify-between pl-[0.5625rem] pr-[0.5625rem]">
