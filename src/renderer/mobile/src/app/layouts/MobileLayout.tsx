...
const MobileLayout = () => {
  ...
  return (
    <div className="min-h-dvh bg-gray-100 flex justify-center">
      <div className="w-full sm:w-[430px] bg-white min-h-dvh relative flex flex-col sm:border-x sm:border-gray-200 sm:shadow-[0_0_24px_rgba(0,0,0,0.05)] transform-gpu overflow-hidden">
        <main
